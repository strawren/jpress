$(function(){
    ...
    +'        <li><a id="normal-mode" href="#normal-mode">常规显示</a></li>'
    +'        <li><a id="fixedtop-mode" href="#fixedtop-mode">固定头部</a></li>'
    +'        <li><a id="fixedside-mode" href="#fixedside-mode">固定头部边框</a></li>'
    +'        <li><a id="fixedsideonly-mode" href="#fixedsideonly-mode">仅固定边框</a></li>'
    +'    </ul>'
    ...
    $(window).scroll(function() {
        ...
        // this for hide/show button to-top  ($(document.body).height() - $(document).height())
        if($(this).scrollTop() > 0) {
