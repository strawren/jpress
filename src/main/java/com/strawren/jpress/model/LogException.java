...
/**
 * 模型类，异常日志，异常信息，时间，关联的组件等：是否需要人工来处理，处理状态等，对应表LOG_EXCEPTION.
 */
public class LogException extends Model {
	...
	entityMap.put("errSummary", errSummary);
        this.errSummary = errSummary;
    }

    public String getErrTrack(){
        return errTrack;
    }

    public void setErrTrack(String errTrack){
	entityMap.put("errTrack", errTrack);
        this.errTrack = errTrack;
    }
